    ...
    'transforms' => [
        'render' => function ($node) {
            ...
            $getIconOptions = function ($node) use ($image) {
                ...
                $markerclass = $node->props['marker_icon_class'];
                $markerid = $node->props['marker_icon_id'];
                ...
                return [
                    ...
                    'iconClass' => 'wbc_'.$markerclass,
                    'markerId' => $markerclass,
                ];
            };
            ...
            $metadata->set('script:wbcbuilder-initmap', [
                'src' => Path::get('./app/init_map.js'),
                'defer' => true,
            ]);
            $metadata->set('script:wbcbuilder-map', [
                'src' => Path::get('./app/wbc_map.js'),
                'defer' => true,
            ]);
        },
    ],
